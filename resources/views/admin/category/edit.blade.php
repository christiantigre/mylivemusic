        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    <div class="panel-heading">{{ trans('adminlte::adminlte.Edit') }} Category #{{ $category->id }}</div>
                    <div class="panel-body">
                        ...
                        <form method="POST" action="{{ url('/admin/category/' . $category->id) }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            @include ('admin.category.form', ['submitButtonText' => trans('adminlte::adminlte.Update') ])
