        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    <div class="panel-heading">Estate {{ $estate->id }}</div>
                    <div class="panel-body">
                        ...
                        <a href="{{ url('/admin/estate/' . $estate->id . '/edit') }}" title="{{ trans('adminlte::adminlte.Edit') }} Estate"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> {{ trans('adminlte::adminlte.Edit') }}</button></a>

                        <form method="POST" action="{{ url('admin/estate' . '/' . $estate->id) }}" accept-charset="UTF-8" style="display:inline">
                            {{ method_field('DELETE') }}
                            {{ csrf_field() }}
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    <tr>
                                        <th>ID</th><td>{{ $estate->id }}</td>
                                    </tr>
                                    <tr><th> Estate </th><td> {{ $estate->estate }} </td></tr><tr><th> Detall </th><td> {{ $estate->detall }} </td></tr><tr><th> Active </th><td> 
                                        @if(($estate->active)=='1')
