        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    <div class="panel-heading">{{ trans('adminlte::adminlte.Country') }}</div>
                    <div class="panel-body">
                        <a href="{{ url('/admin/country/create') }}" class="btn btn-success btn-sm" title="{{ trans('adminlte::adminlte.Add_New') }} {{ trans('adminlte::adminlte.Country') }} ">
                            <i class="fa fa-plus" aria-hidden="true"></i> {{ trans('adminlte::adminlte.Add_New') }}
                        </a>

                        <form method="GET" action="{{ url('/admin/country') }}" accept-charset="UTF-8" class="navbar-form navbar-right" role="search">
                            ...
                            <table class="table">
                                ...
                                @foreach($country as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('/admin/country/' . $item->id) }}" title="{{ trans('adminlte::adminlte.View') }} {{ trans('adminlte::adminlte.Country') }}"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> {{ trans('adminlte::adminlte.View') }}</button></a>
                                            <a href="{{ url('/admin/country/' . $item->id . '/edit') }}" title="{{ trans('adminlte::adminlte.Edit') }} {{ trans('adminlte::adminlte.Country') }}"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> {{ trans('adminlte::adminlte.Edit') }}</button></a>
