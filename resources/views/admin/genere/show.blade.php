        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    <div class="panel-heading">Genere {{ $genere->id }}</div>
                    <div class="panel-body">
                        ...
                        <a href="{{ url('/admin/genere/' . $genere->id . '/edit') }}" title="{{ trans('adminlte::adminlte.Edit') }} Genere"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> {{ trans('adminlte::adminlte.Edit') }}</button></a>

                        <form method="POST" action="{{ url('admin/genere' . '/' . $genere->id) }}" accept-charset="UTF-8" style="display:inline">
                            {{ method_field('DELETE') }}
                            {{ csrf_field() }}
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    <tr>
                                        <th>ID</th><td>{{ $genere->id }}</td>
                                    </tr>
                                    <tr><th> Genere Music </th><td> {{ $genere->genere_music }} </td></tr><tr><th> Detall </th><td> {{ $genere->detall }} </td></tr><tr><th> Active </th><td>
                                            @if(($genere->active)=='1')
