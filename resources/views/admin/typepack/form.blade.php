...
<div class="col-md-12">
    ...
    <div class="col-md-6">
        ...
        <div class="form-group {{ $errors->has('pack_type') ? 'has-error' : ''}}">
                <label for="pack_type" class="control-label">{{ 'Pack Type' }}</label>
        ...
        <div class="form-group {{ $errors->has('pack_price_suscription') ? 'has-error' : ''}}">
            <label for="pack_price_suscription" class="control-label">{{ 'Price Suscription' }}</label>
        ...
        <div class="form-group {{ $errors->has('active') ? 'has-error' : ''}}">
            <label for="active" class="control-label">{{ 'Active' }}</label>
                <div class="radio">
                    <label><input name="active" type="radio" value="1" @if (isset($typepack)) {{ (1 == $typepack->active) ? 'checked' : '' }} @else {{ 'checked' }} @endif> Yes</label>
                </div>
                <div class="radio">
                    <label><input name="active" type="radio" value="0" {{ (isset($typepack) && 0 == $typepack->active) ? 'checked' : '' }}> No</label>
                </div>
    ...
    <div class="col-md-6">
        ...
        <div class="form-group {{ $errors->has('pack_detall') ? 'has-error' : ''}}">
            <label for="pack_detall" class="control-label">{{ 'Pack Detall' }}</label>
        ...
        <div class="form-group {{ $errors->has('pack_price_month') ? 'has-error' : ''}}">
            <label for="pack_price_month" class="control-label">{{ 'Price Menth' }}</label>
